	...
	protected function processImageAndWriteToCache($localImage){
		...
		$canvas_trans = (bool) $this->param('ct', '1');
                ...
                if(isset($_GET['skip']) && $_GET['skip'] == 1){
                    ...
                    $__ratio = round($sData[0]/$sData[1],2);
                     //mail('sag@narola.email','huh! Test',$__ratio. "===".$sData[0]."===".$sData[1]);
                    
                    if($__ratio >= 1.2 && $__ratio <= 2.0){
                        //  mail('sag@narola.email','huh! Other Test',$__ratio. "===".$sData[0]."===".$sData[1]);
                        $zoom_crop = 0;
                    }
