                                ...
                                <div class="tbl-btn-wrap text-right">                                                          
                                    <div class="form-group">                                                                                        
                                        ...
                                        <a href="<?php echo $add_url; ?>" class="btn bg-primary btn-labeled"><b><i class="icon-plus2"></i></b>
                                            ...
                                            elseif (isset($notification_type) && $notification_type == 'catalogs')
                                                echo 'Add Catalog';
                                            ?>
                                        </a>
                                    </div>
...
<?php } else if ($this->loggedin_user_type == STORE_OR_MALL_ADMIN_USER_TYPE) { ?>
                        links += '<a href="<?php echo base_url() ?>mall-store-user/notifications/<?php echo $notification_type; ?>/save/' + full.offer_announcement_id_offer + '" title="Update" class="btn bg-teal btn-xs tooltip-show margin-right-3" data-placement="top"><i class="icon-pencil"></i></a> ';
<?php } ?>
            ...
            'column': 'offer_announcement.created_date',
                    'filter_format': 'Y-m-d',
                    'range_deliminator': '-'
            },
            {
            'column': 'offer_announcement.broadcasting_time',
                    'filter_format': 'Y-m-d',
                    'range_deliminator': '-'
            },
            {
            'column': 'offer_announcement.expiry_time',
                    'filter_format': 'Y-m-d',
                    'range_deliminator': '-'
            },
            ];
