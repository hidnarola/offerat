...
function is_logged_in() {
    ...
    if ($loggedin_user_type == 1 && (in_array($segment1, array('super-admin', 'superadmin')))) {
        return TRUE;
//    } elseif (!in_array($segment1, array('login', 'forgot-password', 'reset-password'))) {
    } elseif ($loggedin_user_type == 1 && in_array($segment1, array('login', 'forgot-password', 'reset-password'))) {
